...
public class Storage {
  ...
  public EntityCollection readFunctionImportCollection(final UriResourceFunction uriResourceFunction,
    ...
    if(Constants.FUNCTION_COUNT_CATEGORIES.equals(uriResourceFunction.getFunctionImport().getName())) {
      ...
      final EdmEntityType productEntityType = serviceMetadata.getEdm().getEntityType(Constants.ET_PRODUCT_FQN);
  ...
  public EntityCollection readEntitySetData(EdmEntitySet edmEntitySet) throws ODataApplicationException {
    ...
    } else if(edmEntitySet.getName().equals(Constants.ES_CATEGORIES_NAME)) {
  ...
  public EntityCollection readEntitySetData(String edmEntityTypeName) throws ODataApplicationException {
    ...
    if (edmEntityTypeName.equals(Constants.ET_PRODUCT_NAME)) {
      return getEntityCollection(productList);
    } else if(edmEntityTypeName.equals(Constants.ET_CATEGORY_NAME)) {
      return getEntityCollection(categoryList);
    }
  ...
  public Entity readEntityData(String entityTypeName) {
    ...
    if (entityTypeName.equals(Constants.ET_PRODUCT_NAME)) {
      return  getEntityCollection(productList).getEntities().get(0);
    } else if(entityTypeName.equals(Constants.ET_CATEGORY_NAME)) {
  ...
  public EntityCollection getRelatedEntityCollection(Entity sourceEntity, EdmEntityType targetEntityType) {
    ...
    if (sourceEntityFqn.equals(Constants.ET_PRODUCT_FQN.getFullQualifiedNameAsString())
        && relatedEntityFqn.equals(Constants.ET_CATEGORY_FQN)) {
    ...
    } else if (sourceEntityFqn.equals(Constants.ET_CATEGORY_FQN.getFullQualifiedNameAsString())
        && relatedEntityFqn.equals(Constants.ET_PRODUCT_FQN)) {
  ...
  private void initProductSampleData() {
    ...
    entity.setType(Constants.ET_PRODUCT_FQN.getFullQualifiedNameAsString());
    entity.setId(createId(entity, "ID"));
  ...
  private void initCategorySampleData() {
    ...
    entity.setType(Constants.ET_CATEGORY_FQN.getFullQualifiedNameAsString());
    entity.setId(createId(entity, "ID"));
  ...
  private String getEntitySetName(Entity entity) {
    if(Constants.ET_CATEGORY_FQN.getFullQualifiedNameAsString().equals(entity.getType())) {
      return Constants.ES_CATEGORIES_NAME;
    } else if(Constants.ET_PRODUCT_FQN.getFullQualifiedNameAsString().equals(entity.getType())) {
